...
def loss_batch(model, criterion, xb, yb, opt=None):
    ...
    wealth, water_src, toilet_type, roof, cooking_fuel, drought, pop_density, livestock_bin, agriculture_land_bin = model(xb)
    ...
    pop_density_acc  = accuracy(pop_density, yb['pop_density'], topk=(1,2))
