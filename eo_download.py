...
#    print(url)
#    with open('image_dir/f{cluster}.jpeg', 'wb') as f:
#        im = requests.get(url)
#        f.write(im.content)
...
#     Compute the ND masks
    ...
    try:
        ...
        # print(stack_url)
#        stack_url = ee.data.getThumbnail(ee.data.getThumbId(params={'image': stack, 'dimensions':"512x512", 'format':'jpg'}))
...
def main():
    data = read_df(data_dir/'20-08-2019-clusters.csv')
