...
class DataBunch:
    def __init__(self, img_sz, bs):
        ...
        self.train_ds = SentinelDataset(DATA_PATH/'sentinel', DATA_PATH/'sentinel.csv', True,  transform['train'], None)
        self.valid_ds = SentinelDataset(DATA_PATH/'sentinel', DATA_PATH/'sentinel.csv', False, transform['valid'], None)
